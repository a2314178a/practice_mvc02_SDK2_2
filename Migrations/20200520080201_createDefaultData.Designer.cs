...
namespace practice_mvc02.Migrations
{
    ...
    [Migration("20200520080201_createDefaultData")]
    partial class createDefaultData
    {
            ...
            modelBuilder.Entity("practice_mvc02.Models.dataTable.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            accLV = 999,
                            account = "DIMA",
                            createTime = new DateTime(2020, 5, 20, 16, 2, 0, 700, DateTimeKind.Utc).AddTicks(1644),
                            departmentID = 0,
                            groupID = 0,
                            lastOperaAccID = 0,
                            password = "B72E07D7CA9ACD1262286FD6A3101E3A",
                            timeRuleID = 0,
                            updateTime = new DateTime(2020, 5, 20, 16, 2, 0, 700, DateTimeKind.Utc).AddTicks(2007),
                            userName = "DIMA_Admin"
                        });
                });
