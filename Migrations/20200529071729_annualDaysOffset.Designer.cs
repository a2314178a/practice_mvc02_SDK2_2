...
namespace practice_mvc02.Migrations
{
    ...
    [Migration("20200529071729_annualDaysOffset")]
            ...
            modelBuilder.Entity("practice_mvc02.Models.dataTable.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            accLV = 999,
                            account = "DIMA",
                            createTime = new DateTime(2020, 5, 29, 15, 17, 29, 99, DateTimeKind.Utc).AddTicks(3602),
                            departmentID = 0,
                            groupID = 0,
                            lastOperaAccID = 0,
                            password = "B72E07D7CA9ACD1262286FD6A3101E3A",
                            timeRuleID = 0,
                            updateTime = new DateTime(2020, 5, 29, 15, 17, 29, 99, DateTimeKind.Utc).AddTicks(3973),
                            userName = "DIMA_Admin"
                        });
                });
