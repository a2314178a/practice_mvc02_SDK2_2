...
namespace practice_mvc02.Migrations
{
    ...
    [Migration("20200609053510_emAnnualLastOpIDcreateOpLogTB")]
    partial class emAnnualLastOpIDcreateOpLogTB
    {
            ...
            modelBuilder.Entity("practice_mvc02.Models.dataTable.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            accLV = 999,
                            account = "DIMA",
                            createTime = new DateTime(2020, 6, 9, 13, 35, 10, 393, DateTimeKind.Utc).AddTicks(1154),
                            departmentID = 0,
                            groupID = 0,
                            lastOperaAccID = 0,
                            password = "B72E07D7CA9ACD1262286FD6A3101E3A",
                            timeRuleID = 0,
                            updateTime = new DateTime(2020, 6, 9, 13, 35, 10, 393, DateTimeKind.Utc).AddTicks(1538),
                            userName = "DIMA_Admin"
                        });
                });
