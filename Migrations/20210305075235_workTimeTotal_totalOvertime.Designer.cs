...
namespace practice_mvc02.Migrations
{
    ...
    [Migration("20210305075235_workTimeTotal_totalOvertime")]
    partial class workTimeTotal_totalOvertime
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("practice_mvc02.Models.dataTable.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            accLV = 999,
                            account = "DIMA",
                            createTime = new DateTime(2021, 3, 5, 15, 52, 35, 488, DateTimeKind.Utc).AddTicks(9565),
                            departmentID = 0,
                            groupID = 0,
                            lastOperaAccID = 0,
                            password = "B72E07D7CA9ACD1262286FD6A3101E3A",
                            timeRuleID = 0,
                            updateTime = new DateTime(2021, 3, 5, 15, 52, 35, 488, DateTimeKind.Utc).AddTicks(9861),
                            userName = "DIMA_Admin"
                        });
                });
            ...
            modelBuilder.Entity("practice_mvc02.Models.dataTable.OverTimeRest", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("overTimeRest");
                });

            modelBuilder.Entity("practice_mvc02.Models.dataTable.OvertimeApply", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd();
